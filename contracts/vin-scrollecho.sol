...
contract VinScrollEcho {
    ...
    event EchoResonated(uint256 indexed id, string sourceType, string reference, string message, address origin, uint256 timestamp);
    ...
    function resonate(
        ...
        emit EchoResonated(echoes.length - 1, sourceType, reference, message, msg.sender, block.timestamp);
    }
