...
contract RestorationFestivalProtocolDAO {
    ...
    function scheduleFestival(string memory _theme, string memory _corridor, uint256 _date) external onlyAdmin {
        festivals.push(Festival(_theme, _corridor, _date, false));
    }
