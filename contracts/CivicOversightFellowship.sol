...
contract CivicOversightFellowship {
    ...
    function summonFellowship(string memory oversightTheme, string memory fellowshipAction, string memory emotionalTag) external onlyAdmin {
        entries.push(FellowshipEntry(oversightTheme, fellowshipAction, emotionalTag, true, false));
    }
