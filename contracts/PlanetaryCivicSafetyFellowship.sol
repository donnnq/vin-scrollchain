...
contract PlanetaryCivicSafetyFellowship {
    ...
    function summonFellowship(string memory civicZone, string memory safetyProtocol, string memory emotionalTag) external onlyAdmin {
        entries.push(FellowshipEntry(civicZone, safetyProtocol, emotionalTag, true, false));
    }
