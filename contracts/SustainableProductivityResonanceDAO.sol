// SustainableProductivityResonanceDAO.sol
pragma solidity ^0.8.0;

contract SustainableProductivityResonanceDAO {
    struct Initiative {
        uint256 id;
        string program;     // e.g. "Balanced Work Charter"
        string resonance;   // e.g. "Align productivity with sustainability and calm"
        bool active;
    }
