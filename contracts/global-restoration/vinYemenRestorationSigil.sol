...
contract vinYemenRestorationSigil {
    address public scrollCaster;
    address public yemenTreasury;
    ...
    constructor(address _yemenTreasury) {
        scrollCaster = msg.sender;
        yemenTreasury = _yemenTreasury;
    }
    ...
    function invokeRestoration() external {
        ...
        invoked = true;
        emit RestorationDeployed(scrollCaster, yemenTreasury, blessingAmount, "May Yemen’s suffering end and restoration begin.");
    }
}
