...
contract PlanetaryCivicReckoningFellowship {
    ...
    function summonFellowship(string memory civicTheme, string memory reckoningAction, string memory emotionalTag) external onlyAdmin {
        entries.push(FellowshipEntry(civicTheme, reckoningAction, emotionalTag, true, false));
    }
