// SolidarityResonanceDAO.sol
pragma solidity ^0.8.0;

contract SolidarityResonanceDAO {
    struct Initiative {
        uint256 id;
        string program;     // e.g. "Empathy and Dignity Charter"
        string resonance;   // e.g. "Align governance with solidarity and respect"
        bool active;
    }
