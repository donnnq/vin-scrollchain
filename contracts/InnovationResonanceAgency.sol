// InnovationResonanceAgency.sol
pragma solidity ^0.8.0;

contract InnovationResonanceAgency {
    struct Initiative {
        uint256 id;
        string program;     // e.g. "Global Client Service"
        string resonance;   // e.g. "Align AI with human creativity"
        bool active;
    }
