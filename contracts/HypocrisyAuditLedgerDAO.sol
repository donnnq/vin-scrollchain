...
contract HypocrisyAuditLedgerDAO {
    ...
    function logAudit(address initiator, string memory institution, string memory contradiction, string memory emotionalTag) external onlySteward {
        audits.push(Audit({
            initiator: initiator,
