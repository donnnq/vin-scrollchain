...
contract FloodControlAuditProtocol {
    ...
    function summonAudit(string memory projectName, string memory region, string memory auditStatus, string memory emotionalTag) external onlyAdmin {
        entries.push(AuditEntry(projectName, region, auditStatus, emotionalTag, true, false, false));
    }
