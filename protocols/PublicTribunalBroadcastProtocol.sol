...
contract PublicTribunalBroadcastProtocol {
    ...
    function summonTribunal(string memory caseName, string memory location, string memory emotionalTag) external onlyAdmin {
        entries.push(TribunalEntry(caseName, location, emotionalTag, true, false, false));
    }
