...
contract ResonanceCodexPoliticalAccountability {
    ...
    struct CodexEntry {
        string theme;       // impeachment legitimacy, alliance audit, governance consequence
        string narrative;   // how accountability reshapes communal trust and validator-grade consequence
        uint256 timestamp;
    }
