...
contract KMJSTruthFestivalProtocol {
    ...
    function summonFestival(string memory episodeTitle, string memory hostName, string memory civicTheme, string memory emotionalTag) external onlyAdmin {
        entries.push(FestivalEntry(episodeTitle, hostName, civicTheme, emotionalTag, true, false, false));
    }
