...
contract GenZHousingFestivalProtocol {
    ...
    function summonFestival(string memory eventName, string memory location, string memory youthTheme, string memory emotionalTag) external onlyAdmin {
        entries.push(FestivalEntry(eventName, location, youthTheme, emotionalTag, true, false, false));
    }
