...
contract ResonanceCodexFoodSovereigntyII {
    ...
    struct CodexEntry {
        string theme;       // agricultural equity, nutrition chain audit, farmer resilience
        string narrative;   // how food sovereignty reshapes communal trust and validator-grade consequence
        uint256 timestamp;
    }
