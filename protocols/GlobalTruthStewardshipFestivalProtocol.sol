...
contract GlobalTruthStewardshipFestivalProtocol {
    address public admin;

    struct FestivalEntry {
        string eventName;
        string stewardshipTheme;
    ...
    function summonFestival(string memory eventName, string memory stewardshipTheme, string memory citationClause, string memory emotionalTag) external onlyAdmin {
        entries.push(FestivalEntry(eventName, stewardshipTheme, citationClause, emotionalTag, true, false, false));
    }
