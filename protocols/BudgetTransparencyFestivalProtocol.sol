...
contract BudgetTransparencyFestivalProtocol {
    ...
    function summonFestival(string memory eventName, string memory transparencyTheme, string memory fiscalClause, string memory emotionalTag) external onlyAdmin {
        entries.push(FestivalEntry(eventName, transparencyTheme, fiscalClause, emotionalTag, true, false, false));
    }
