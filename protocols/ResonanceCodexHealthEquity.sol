...
contract ResonanceCodexHealthEquity {
    ...
    struct CodexEntry {
        string theme;       // medicine access, hospital audit, public health dignity
        string narrative;   // how health equity reshapes communal trust and validator-grade consequence
        uint256 timestamp;
    }
