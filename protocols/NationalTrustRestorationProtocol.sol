...
contract NationalTrustRestorationProtocol {
    ...
    function summonRestoration(string memory institution, string memory trustIssue, string memory restorationClause, string memory emotionalTag) external onlyAdmin {
        entries.push(RestorationEntry(institution, trustIssue, restorationClause, emotionalTag, true, false, false));
    }
