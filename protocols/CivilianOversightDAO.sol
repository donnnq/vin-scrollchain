...
contract CivilianOversightDAO {
    ...
    function summonOversight(string memory country, string memory institution, string memory oversightClause, string memory emotionalTag) external onlyAdmin {
        entries.push(OversightEntry(country, institution, oversightClause, emotionalTag, true, false, false));
    }
