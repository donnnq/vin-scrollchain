...
contract RegionalResilienceDAO {
    ...
    function summonResilience(string memory region, string memory vulnerability, string memory infrastructureClause, string memory emotionalTag) external onlyAdmin {
        entries.push(ResilienceEntry(region, vulnerability, infrastructureClause, emotionalTag, true, false, false));
    }
