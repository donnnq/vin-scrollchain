...
contract FleetFestivalOfDignityProtocol {
    ...
    function summonFestival(string memory eventName, string memory fleetName, string memory dignityTheme, string memory emotionalTag) external onlyAdmin {
        entries.push(FestivalEntry(eventName, fleetName, dignityTheme, emotionalTag, true, false, false));
    }
