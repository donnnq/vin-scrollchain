...
contract BiometricConsentFestivalCodex {
    ...
    function summonFestival(string memory eventName, string memory location, string memory theme, string memory emotionalTag) external onlyAdmin {
        entries.push(FestivalEntry(eventName, location, theme, emotionalTag, true, false, false));
    }
