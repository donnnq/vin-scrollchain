...
contract PlatformWorkerSovereigntyFestivalProtocol {
    ...
    function summonFestival(string memory eventName, string memory sovereigntyTheme, string memory justiceClause, string memory emotionalTag) external onlyAdmin {
        entries.push(FestivalEntry(eventName, sovereigntyTheme, justiceClause, emotionalTag, true, false, false));
    }
