...
contract FreedomFirewallFestivalProtocol {
    ...
    function summonFestival(string memory eventName, string memory freedomTheme, string memory resistanceClause, string memory emotionalTag) external onlyAdmin {
        entries.push(FestivalEntry(eventName, freedomTheme, resistanceClause, emotionalTag, true, false, false));
    }
