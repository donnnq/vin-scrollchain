...
contract ResonanceCodexClimateJusticeII {
    ...
    struct CodexEntry {
        string theme;       // carbon equity, adaptation justice, planetary fairness
        string narrative;   // how climate justice reshapes communal trust and validator-grade consequence
        uint256 timestamp;
    }
