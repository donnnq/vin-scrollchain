...
contract PublicWorksJusticeFestivalProtocol {
    ...
    function summonFestival(string memory eventName, string memory justiceTheme, string memory resilienceClause, string memory emotionalTag) external onlyAdmin {
        entries.push(FestivalEntry(eventName, justiceTheme, resilienceClause, emotionalTag, true, false, false));
    }
