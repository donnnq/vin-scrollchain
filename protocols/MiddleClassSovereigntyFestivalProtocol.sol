...
contract MiddleClassSovereigntyFestivalProtocol {
    ...
    function summonFestival(string memory eventName, string memory sovereigntyTheme, string memory equityClause, string memory emotionalTag) external onlyAdmin {
        entries.push(FestivalEntry(eventName, sovereigntyTheme, equityClause, emotionalTag, true, false, false));
    }
