...
contract ContainerDormFestivalCodex {
    ...
    function summonFestival(string memory eventName, string memory dormLocation, string memory designTheme, string memory emotionalTag) external onlyAdmin {
        entries.push(FestivalEntry(eventName, dormLocation, designTheme, emotionalTag, true, false, false));
    }
