...
contract ResonanceCodexSupplyChainJustice {
    ...
    struct CodexEntry {
        string theme;       // fair trade, logistics audit, commerce resilience
        string narrative;   // how supply chain justice reshapes communal trust and validator-grade consequence
        uint256 timestamp;
    }
