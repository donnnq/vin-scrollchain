...
contract ResonanceCodexEconomicEquity {
    ...
    struct CodexEntry {
        string theme;       // wealth distribution, fiscal policy, resilience
        string narrative;   // how equity reshapes communal trust and validator-grade consequence
        uint256 timestamp;
    }
