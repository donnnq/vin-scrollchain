...
contract ResonanceCodexCrisisAccountability {
    ...
    struct CodexEntry {
        string theme;       // fire safety, tech security, governance legitimacy
        string narrative;   // how crises reshape communal trust and validator-grade consequence
        uint256 timestamp;
    }
