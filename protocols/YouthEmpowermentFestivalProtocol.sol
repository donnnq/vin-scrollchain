...
contract YouthEmpowermentFestivalProtocol {
    ...
    function summonFestival(string memory eventName, string memory empowermentTheme, string memory grantClause, string memory emotionalTag) external onlyAdmin {
        entries.push(FestivalEntry(eventName, empowermentTheme, grantClause, emotionalTag, true, false, false));
    }
