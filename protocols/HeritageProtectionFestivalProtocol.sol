...
contract HeritageProtectionFestivalProtocol {
    ...
    function summonFestival(string memory eventName, string memory protectionTheme, string memory defenseClause, string memory emotionalTag) external onlyAdmin {
        entries.push(FestivalEntry(eventName, protectionTheme, defenseClause, emotionalTag, true, false, false));
    }
