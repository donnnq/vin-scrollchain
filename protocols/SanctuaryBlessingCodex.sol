...
contract SanctuaryBlessingCodex {
    address public admin;

    struct BlessingEntry {
        string amenityType; // "Portalet", "Handwash Station", "Trash Can"
        string location;
    ...
    function summonBlessing(string memory amenityType, string memory location, string memory blessingClause, string memory emotionalTag) external onlyAdmin {
        entries.push(BlessingEntry(amenityType, location, blessingClause, emotionalTag, true, false, false));
    }
