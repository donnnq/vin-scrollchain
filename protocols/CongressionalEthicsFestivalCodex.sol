...
contract CongressionalEthicsFestivalCodex {
    ...
    function summonFestival(string memory eventName, string memory hostDistrict, string memory ethicsTheme, string memory emotionalTag) external onlyAdmin {
        entries.push(FestivalEntry(eventName, hostDistrict, ethicsTheme, emotionalTag, true, false, false));
    }
