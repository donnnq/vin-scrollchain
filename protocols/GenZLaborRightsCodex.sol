...
contract GenZLaborRightsCodex {
    ...
    function summonRights(string memory sector, string memory protectionClause, string memory emotionalTag) external onlyAdmin {
        entries.push(RightsEntry(sector, protectionClause, emotionalTag, true, false, false));
    }
