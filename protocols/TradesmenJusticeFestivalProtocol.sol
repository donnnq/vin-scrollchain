...
contract TradesmenJusticeFestivalProtocol {
    address public admin;

    struct FestivalEntry {
        string eventName;
        string justiceTheme;
        string apprenticeshipClause;
        string emotionalTag;
        bool summoned;
        bool celebrated;
        bool sealed;
    ...
    function summonFestival(string memory eventName, string memory justiceTheme, string memory apprenticeshipClause, string memory emotionalTag) external onlyAdmin {
        entries.push(FestivalEntry(eventName, justiceTheme, apprenticeshipClause, emotionalTag, true, false, false));
    }
