...
contract DICTFestivalMapCodex {
    ...
    function summonFestival(string memory eventName, string memory region, string memory techFocus, string memory emotionalTag) external onlyAdmin {
        entries.push(FestivalEntry(eventName, region, techFocus, emotionalTag, true, false, false));
    }
