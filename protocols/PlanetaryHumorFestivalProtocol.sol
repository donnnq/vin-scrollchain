...
contract PlanetaryHumorFestivalProtocol {
    ...
    function summonFestival(string memory eventName, string memory humorTheme, string memory satireClause, string memory emotionalTag) external onlyAdmin {
        entries.push(FestivalEntry(eventName, humorTheme, satireClause, emotionalTag, true, false, false));
    }
