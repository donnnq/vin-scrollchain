...
contract FloodMappingCodex {
    ...
    function summonMapping(string memory barangayName, string memory floodZone, string memory mappingClause, string memory emotionalTag) external onlyAdmin {
        entries.push(MappingEntry(barangayName, floodZone, mappingClause, emotionalTag, true, false, false));
    }
