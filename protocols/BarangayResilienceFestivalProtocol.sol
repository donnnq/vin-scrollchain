...
contract BarangayResilienceFestivalProtocol {
    ...
    function summonFestival(string memory eventName, string memory resilienceTheme, string memory reformClause, string memory emotionalTag) external onlyAdmin {
        entries.push(FestivalEntry(eventName, resilienceTheme, reformClause, emotionalTag, true, false, false));
    }
