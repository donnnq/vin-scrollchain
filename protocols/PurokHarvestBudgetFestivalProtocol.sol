...
contract PurokHarvestBudgetFestivalProtocol {
    ...
    function summonFestival(string memory purokName, string memory harvestType, uint256 budgetAllocated, string memory emotionalTag) external onlyAdmin {
        entries.push(FestivalEntry(purokName, harvestType, budgetAllocated, emotionalTag, true, false, false));
    }
