...
contract TransparencySovereigntyFestivalProtocol {
    ...
    function summonFestival(string memory eventName, string memory transparencyTheme, string memory ethicsClause, string memory emotionalTag) external onlyAdmin {
        entries.push(FestivalEntry(eventName, transparencyTheme, ethicsClause, emotionalTag, true, false, false));
    }
