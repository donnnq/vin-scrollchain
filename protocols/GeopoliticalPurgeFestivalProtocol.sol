...
contract GeopoliticalPurgeFestivalProtocol {
    ...
    function summonFestival(string memory eventName, string memory purgeTheme, string memory loyaltyClause, string memory emotionalTag) external onlyAdmin {
        entries.push(FestivalEntry(eventName, purgeTheme, loyaltyClause, emotionalTag, true, false, false));
    }
