...
contract CommandReckoningFestivalProtocol {
    address public admin;

    struct FestivalEntry {
        string eventName;
        string reckoningTheme;
        string deterrenceClause;
        string emotionalTag;
        bool summoned;
        bool celebrated;
        bool sealed;
    ...
    function summonFestival(string memory eventName, string memory reckoningTheme, string memory deterrenceClause, string memory emotionalTag) external onlyAdmin {
        entries.push(FestivalEntry(eventName, reckoningTheme, deterrenceClause, emotionalTag, true, false, false));
    }
