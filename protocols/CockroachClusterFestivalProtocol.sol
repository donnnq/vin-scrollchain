...
contract CockroachClusterFestivalProtocol {
    ...
    function summonFestival(string memory eventName, string memory clusterTheme, string memory auditClause, string memory emotionalTag) external onlyAdmin {
        entries.push(FestivalEntry(eventName, clusterTheme, auditClause, emotionalTag, true, false, false));
    }
