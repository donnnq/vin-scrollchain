...
contract ResonanceCodexInvestorProof {
    ...
    struct CodexEntry {
        string theme;       // investor proof, participation audit
        string narrative;   // how certificates and transaction advice reshape communal trust and validator-grade consequence
        uint256 timestamp;
    }
