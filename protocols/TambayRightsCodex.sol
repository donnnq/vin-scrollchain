...
contract TambayRightsCodex {
    ...
    function summonRights(string memory zoneName, string memory dignityClause, string memory emotionalTag) external onlyAdmin {
        entries.push(RightsEntry(zoneName, dignityClause, emotionalTag, true, false, false));
    }
