...
contract GlobalComfortFestivalProtocol {
    ...
    function summonFestival(string memory eventName, string memory featuredDish, string memory comfortTheme, string memory emotionalTag) external onlyAdmin {
        entries.push(FestivalEntry(eventName, featuredDish, comfortTheme, emotionalTag, true, false, false));
    }
