...
contract TruthSovereigntyFestivalProtocol {
    ...
    function summonFestival(string memory eventName, string memory hostRegion, string memory truthTheme, string memory emotionalTag) external onlyAdmin {
        entries.push(FestivalEntry(eventName, hostRegion, truthTheme, emotionalTag, true, false, false));
    }
