...
contract ResonanceCodexInfoSovereignty {
    ...
    struct CodexEntry {
        string theme;       // information sovereignty, global governance
        string narrative;   // how disputes reshape consequence and trust
        uint256 timestamp;
    }
