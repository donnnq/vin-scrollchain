...
contract SandboxEthicsFestivalProtocol {
    ...
    function summonFestival(string memory eventName, string memory location, string memory featuredTech, string memory emotionalTag) external onlyAdmin {
        entries.push(FestivalEntry(eventName, location, featuredTech, emotionalTag, true, false, false));
    }
