...
contract PlanetaryRespectFestivalProtocol {
    ...
    function summonFestival(string memory eventName, string memory respectTheme, string memory dignityClause, string memory emotionalTag) external onlyAdmin {
        entries.push(FestivalEntry(eventName, respectTheme, dignityClause, emotionalTag, true, false, false));
    }
