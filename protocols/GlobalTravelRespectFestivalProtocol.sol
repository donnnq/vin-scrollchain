...
contract GlobalTravelRespectFestivalProtocol {
    ...
    function summonFestival(string memory eventName, string memory travelTheme, string memory dignityClause, string memory emotionalTag) external onlyAdmin {
        entries.push(FestivalEntry(eventName, travelTheme, dignityClause, emotionalTag, true, false, false));
    }
