...
contract CivicBlessingProtocol {
    ...
    function summonBlessing(string memory district, string memory infrastructureType, string memory blessingClause, string memory emotionalTag) external onlyAdmin {
        entries.push(BlessingEntry(district, infrastructureType, blessingClause, emotionalTag, true, false, false));
    }
