...
contract PublicIntegrityFestivalProtocol {
    ...
    function summonFestival(string memory eventName, string memory integrityTheme, string memory accountabilityClause, string memory emotionalTag) external onlyAdmin {
        entries.push(FestivalEntry(eventName, integrityTheme, accountabilityClause, emotionalTag, true, false, false));
    }
