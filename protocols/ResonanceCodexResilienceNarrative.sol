...
contract ResonanceCodexResilienceNarrative {
    ...
    struct CodexEntry {
        string theme;       // resilience, adaptation, communal audit
        string narrative;   // how recovery reshapes trust and validator-grade consequence
        uint256 timestamp;
    }
