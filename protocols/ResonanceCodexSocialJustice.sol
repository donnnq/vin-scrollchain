...
contract ResonanceCodexSocialJustice {
    ...
    struct CodexEntry {
        string theme;       // rights equity, legal safeguards, civic empowerment
        string narrative;   // how social justice reshapes communal trust and validator-grade consequence
        uint256 timestamp;
    }
