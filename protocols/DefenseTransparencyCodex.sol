...
contract DefenseTransparencyCodex {
    ...
    function summonTransparency(string memory officerName, string memory commandZone, string memory transparencyClause, string memory emotionalTag) external onlyAdmin {
        entries.push(TransparencyEntry(officerName, commandZone, transparencyClause, emotionalTag, true, false, false));
    }
