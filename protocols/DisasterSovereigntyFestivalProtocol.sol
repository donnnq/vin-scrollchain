...
contract DisasterSovereigntyFestivalProtocol {
    address public admin;

    struct FestivalEntry {
        string eventName;
        string disasterTheme;
    ...
    function summonFestival(string memory eventName, string memory disasterTheme, string memory adaptationClause, string memory emotionalTag) external onlyAdmin {
        entries.push(FestivalEntry(eventName, disasterTheme, adaptationClause, emotionalTag, true, false, false));
    }
