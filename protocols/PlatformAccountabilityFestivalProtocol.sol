...
contract PlatformAccountabilityFestivalProtocol {
    address public admin;

    struct FestivalEntry {
        string eventName;
        string accountabilityTheme;
    ...
    function summonFestival(string memory eventName, string memory accountabilityTheme, string memory restitutionClause, string memory emotionalTag) external onlyAdmin {
        entries.push(FestivalEntry(eventName, accountabilityTheme, restitutionClause, emotionalTag, true, false, false));
    }
