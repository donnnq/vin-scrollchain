...
contract GlobalSovereigntyFestivalProtocol {
    ...
    function summonFestival(string memory eventName, string memory sovereigntyTheme, string memory dignityClause, string memory emotionalTag) external onlyAdmin {
        entries.push(FestivalEntry(eventName, sovereigntyTheme, dignityClause, emotionalTag, true, false, false));
    }
