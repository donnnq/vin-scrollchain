...
contract ResonanceCodexAviationTrustII {
    ...
    struct CodexEntry {
        string theme;       // air safety equity, flight AI audit, sky resilience
        string narrative;   // how aviation trust reshapes communal trust and validator-grade consequence
        uint256 timestamp;
    }
