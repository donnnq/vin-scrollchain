...
contract AgriRetirementSimulationProtocol {
    ...
    function summonSimulation(string memory region, string memory sectorType, string memory simulationType, string memory emotionalTag) external onlyAdmin {
        entries.push(SimulationEntry(region, sectorType, simulationType, emotionalTag, true, false, false));
    }
