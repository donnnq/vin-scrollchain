...
contract DueProcessFestivalProtocol {
    ...
    function summonFestival(string memory eventName, string memory legalTheme, string memory civicClause, string memory emotionalTag) external onlyAdmin {
        entries.push(FestivalEntry(eventName, legalTheme, civicClause, emotionalTag, true, false, false));
    }
