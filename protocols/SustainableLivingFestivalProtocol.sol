...
contract SustainableLivingFestivalProtocol {
    address public admin;

    struct FestivalEntry {
        string eventName;
        string sustainabilityTheme;
    ...
    function summonFestival(string memory eventName, string memory sustainabilityTheme, string memory housingClause, string memory emotionalTag) external onlyAdmin {
        entries.push(FestivalEntry(eventName, sustainabilityTheme, housingClause, emotionalTag, true, false, false));
    }
