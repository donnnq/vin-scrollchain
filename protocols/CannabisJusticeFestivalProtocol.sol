...
contract CannabisJusticeFestivalProtocol {
    ...
    function summonFestival(string memory eventName, string memory justiceTheme, string memory equityClause, string memory emotionalTag) external onlyAdmin {
        entries.push(FestivalEntry(eventName, justiceTheme, equityClause, emotionalTag, true, false, false));
    }
