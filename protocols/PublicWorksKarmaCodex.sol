...
contract PublicWorksKarmaCodex {
    ...
    function summonKarma(string memory agency, string memory karmicTrigger, string memory auditClause, string memory emotionalTag) external onlyAdmin {
        entries.push(KarmaEntry(agency, karmicTrigger, auditClause, emotionalTag, true, false, false));
    }
