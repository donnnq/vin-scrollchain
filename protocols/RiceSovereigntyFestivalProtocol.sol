...
contract RiceSovereigntyFestivalProtocol {
    ...
    function summonFestival(string memory festivalName, string memory region, string memory activityType, string memory emotionalTag) external onlyAdmin {
        entries.push(FestivalEntry(festivalName, region, activityType, emotionalTag, true, false, false));
    }
