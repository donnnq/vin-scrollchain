...
contract FlavorHeritageRevivalFestivalProtocol {
    ...
    function summonFestival(string memory eventName, string memory revivalTheme, string memory policyClause, string memory emotionalTag) external onlyAdmin {
        entries.push(FestivalEntry(eventName, revivalTheme, policyClause, emotionalTag, true, false, false));
    }
