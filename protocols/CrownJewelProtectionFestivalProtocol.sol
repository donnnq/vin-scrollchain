...
contract CrownJewelProtectionFestivalProtocol {
    ...
    function summonFestival(string memory eventName, string memory protectionTheme, string memory recoveryClause, string memory emotionalTag) external onlyAdmin {
        entries.push(FestivalEntry(eventName, protectionTheme, recoveryClause, emotionalTag, true, false, false));
    }
