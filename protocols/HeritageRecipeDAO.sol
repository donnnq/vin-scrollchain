...
contract HeritageRecipeDAO {
    ...
    function summonRecipe(string memory dishName, string memory culturalOrigin, string memory preservationClause, string memory emotionalTag) external onlyAdmin {
        entries.push(RecipeEntry(dishName, culturalOrigin, preservationClause, emotionalTag, true, false, false));
    }
