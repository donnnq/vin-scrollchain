...
contract ResonanceCodexEnergyResilienceII {
    ...
    struct CodexEntry {
        string theme;       // renewable equity, power grid audit, energy trust
        string narrative;   // how energy resilience reshapes communal trust and validator-grade consequence
        uint256 timestamp;
    }
