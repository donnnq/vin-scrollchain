...
contract LaborSovereigntyFestivalProtocol {
    ...
    function summonFestival(string memory eventName, string memory laborTheme, string memory justiceClause, string memory emotionalTag) external onlyAdmin {
        entries.push(FestivalEntry(eventName, laborTheme, justiceClause, emotionalTag, true, false, false));
    }
