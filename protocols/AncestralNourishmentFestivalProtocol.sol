...
contract AncestralNourishmentFestivalProtocol {
    ...
    function summonFestival(string memory eventName, string memory featuredDish, string memory nourishmentTheme, string memory emotionalTag) external onlyAdmin {
        entries.push(FestivalEntry(eventName, featuredDish, nourishmentTheme, emotionalTag, true, false, false));
    }
