...
contract WalangTirahanDignityFestivalProtocol {
    ...
    function summonFestival(string memory eventName, string memory hostRegion, string memory dignityTheme, string memory emotionalTag) external onlyAdmin {
        entries.push(FestivalEntry(eventName, hostRegion, dignityTheme, emotionalTag, true, false, false));
    }
