...
contract NationalSecurityFestivalProtocol {
    ...
    function summonFestival(string memory eventName, string memory securityTheme, string memory reformClause, string memory emotionalTag) external onlyAdmin {
        entries.push(FestivalEntry(eventName, securityTheme, reformClause, emotionalTag, true, false, false));
    }
