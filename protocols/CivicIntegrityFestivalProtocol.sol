...
contract CivicIntegrityFestivalProtocol {
    ...
    function summonFestival(string memory eventName, string memory integrityTheme, string memory consequenceClause, string memory emotionalTag) external onlyAdmin {
        entries.push(FestivalEntry(eventName, integrityTheme, consequenceClause, emotionalTag, true, false, false));
    }
