...
contract HolidayJusticeFestivalProtocol {
    ...
    function summonFestival(string memory eventName, string memory justiceTheme, string memory affordabilityClause, string memory emotionalTag) external onlyAdmin {
        entries.push(FestivalEntry(eventName, justiceTheme, affordabilityClause, emotionalTag, true, false, false));
    }
