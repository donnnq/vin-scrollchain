...
contract ResonanceCodexConsumerEquity {
    ...
    struct CodexEntry {
        string theme;       // price transparency, subsidy audit, essential goods equity
        string narrative;   // how consumer equity reshapes communal trust and validator-grade consequence
        uint256 timestamp;
    }
