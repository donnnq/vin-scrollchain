...
contract PublicSpaceRespectFestivalProtocol {
    ...
    function summonFestival(string memory eventName, string memory respectTheme, string memory civicClause, string memory emotionalTag) external onlyAdmin {
        entries.push(FestivalEntry(eventName, respectTheme, civicClause, emotionalTag, true, false, false));
    }
