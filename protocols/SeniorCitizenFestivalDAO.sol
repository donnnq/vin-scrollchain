...
contract SeniorCitizenFestivalDAO {
    ...
    function summonFestival(string memory festivalName, string memory barangayName, string memory activityType, string memory emotionalTag) external onlyAdmin {
        entries.push(FestivalEntry(festivalName, barangayName, activityType, emotionalTag, true, false, false));
    }
