...
contract PabahayJusticeFestivalProtocol {
    ...
    function summonFestival(string memory eventName, string memory housingTheme, string memory justiceClause, string memory emotionalTag) external onlyAdmin {
        entries.push(FestivalEntry(eventName, housingTheme, justiceClause, emotionalTag, true, false, false));
    }
