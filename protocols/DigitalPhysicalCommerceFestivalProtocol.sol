...
contract DigitalPhysicalCommerceFestivalProtocol {
    ...
    function summonFestival(string memory eventName, string memory commerceTheme, string memory redevelopmentClause, string memory emotionalTag) external onlyAdmin {
        entries.push(FestivalEntry(eventName, commerceTheme, redevelopmentClause, emotionalTag, true, false, false));
    }
