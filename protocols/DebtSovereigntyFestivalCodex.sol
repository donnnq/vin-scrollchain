...
contract DebtSovereigntyFestivalCodex {
    ...
    function summonFestival(string memory countryName, string memory festivalName, string memory celebrationType, string memory emotionalTag) external onlyAdmin {
        entries.push(FestivalEntry(countryName, festivalName, celebrationType, emotionalTag, true, false, false));
    }
