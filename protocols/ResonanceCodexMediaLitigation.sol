...
contract ResonanceCodexMediaLitigation {
    ...
    struct CodexEntry {
        string theme;       // media lawsuit, sovereignty, diplomacy
        string narrative;   // how litigation reshapes consequence, press freedom
        uint256 timestamp;
    }
