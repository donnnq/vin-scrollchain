...
contract AsiaPacificDefenseFestivalProtocol {
    ...
    function summonFestival(string memory eventName, string memory defenseTheme, string memory sovereigntyClause, string memory emotionalTag) external onlyAdmin {
        entries.push(FestivalEntry(eventName, defenseTheme, sovereigntyClause, emotionalTag, true, false, false));
    }
