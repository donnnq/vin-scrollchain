...
contract DigitalOutageJusticeFestivalProtocol {
    ...
    function summonFestival(string memory eventName, string memory outageTheme, string memory resilienceClause, string memory emotionalTag) external onlyAdmin {
        entries.push(FestivalEntry(eventName, outageTheme, resilienceClause, emotionalTag, true, false, false));
    }
