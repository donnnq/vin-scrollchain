...
contract DevSanctumRecruiterLureImmunityProtocol {
    ...
    function summonLure(string memory developerID, string memory platformUsed, string memory malwareLinked, string memory emotionalTag) external onlyAdmin {
        entries.push(LureEntry(developerID, platformUsed, malwareLinked, emotionalTag, true, false, false));
    }
