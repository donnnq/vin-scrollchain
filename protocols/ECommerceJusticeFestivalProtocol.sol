...
contract ECommerceJusticeFestivalProtocol {
    ...
    function summonFestival(string memory eventName, string memory justiceTheme, string memory platformClause, string memory emotionalTag) external onlyAdmin {
        entries.push(FestivalEntry(eventName, justiceTheme, platformClause, emotionalTag, true, false, false));
    }
