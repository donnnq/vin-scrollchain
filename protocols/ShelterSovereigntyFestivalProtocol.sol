...
contract ShelterSovereigntyFestivalProtocol {
    ...
    function summonFestival(string memory eventName, string memory shelterTheme, string memory equityClause, string memory emotionalTag) external onlyAdmin {
        entries.push(FestivalEntry(eventName, shelterTheme, equityClause, emotionalTag, true, false, false));
    }
