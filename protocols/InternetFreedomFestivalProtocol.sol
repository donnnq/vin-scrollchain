...
contract InternetFreedomFestivalProtocol {
    ...
    function summonFestival(string memory eventName, string memory freedomTheme, string memory auditClause, string memory emotionalTag) external onlyAdmin {
        entries.push(FestivalEntry(eventName, freedomTheme, auditClause, emotionalTag, true, false, false));
    }
