...
contract BarangayTaxReliefFestivalProtocol {
    ...
    function summonFestival(string memory eventName, string memory reliefTheme, string memory overrideClause, string memory emotionalTag) external onlyAdmin {
        entries.push(FestivalEntry(eventName, reliefTheme, overrideClause, emotionalTag, true, false, false));
    }
