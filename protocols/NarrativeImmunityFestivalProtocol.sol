...
contract NarrativeImmunityFestivalProtocol {
    ...
    function summonFestival(string memory eventName, string memory hostRegion, string memory immunityTheme, string memory emotionalTag) external onlyAdmin {
        entries.push(FestivalEntry(eventName, hostRegion, immunityTheme, emotionalTag, true, false, false));
    }
