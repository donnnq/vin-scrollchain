...
contract ResonanceCodexEnergyEquity {
    ...
    struct CodexEntry {
        string theme;       // renewable access, power grid audit, energy resilience
        string narrative;   // how energy equity reshapes communal trust and validator-grade consequence
        uint256 timestamp;
    }
