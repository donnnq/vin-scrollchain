...
contract PlanetaryEthicsFestivalProtocol {
    ...
    function summonFestival(string memory eventName, string memory hostNation, string memory ethicsTheme, string memory emotionalTag) external onlyAdmin {
        entries.push(FestivalEntry(eventName, hostNation, ethicsTheme, emotionalTag, true, false, false));
    }
